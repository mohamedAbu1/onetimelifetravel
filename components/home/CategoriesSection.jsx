...
function CategoryCard({ category, language, theme, tc }) {
  ...
  return (
    ...
    >
      <img src={image} alt={name} loading="lazy" decoding="async" className="absolute inset-0 h-full w-full object-cover transition duration-700 group-hover:scale-110" />
